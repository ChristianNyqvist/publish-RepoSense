...
java -jar RepoSense.jar  --repo https://github.com/Baellaaa/OOSDD_GroceryApp_Sprint4_Daniella.git --output https://github.com/ChristianNyqvist/ChristianNyqvist.github.io.git
